        ...
        body: Slideshow(
          ...
          slides: [
            SlideModel(
                ...
                description:
                    'Ahora puedes monitorear todas las ventas que sucedan en tu negocio desde el dispositivo movil',
                image: 'assets/slideshow/sales_control.svg'),
            SlideModel(
                title: 'Inventory Control',
                subtitle: 'Controla tus Inventarios',
                description:
                    'Monitorea tu inventario para conocer que tienes en existencia y asi tomar decisiones',
                image: 'assets/slideshow/inventory_control.svg'),
            SlideModel(
                title: 'Products Control',
                subtitle: 'Controla tus Productos',
                description:
                    'Verifica todos los productos y sus caracteristicas con los que cuenta tu negocio',
                image: 'assets/slideshow/products_control.svg'),
            SlideModel(
                title: 'Cash Register Control',
                subtitle: 'Controla el Corte de Cajas',
                description:
                    'Conoce los cortes de caja que sucen cada dia en tu negocio desde cualquier lugar que te encuentres',
