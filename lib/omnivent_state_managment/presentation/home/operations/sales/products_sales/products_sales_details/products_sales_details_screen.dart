      ...
      body: SingleChildScrollView(
          ...
          children: [
            ...
            Padding(
              ...
              SizedBox(height: 40),
              Center(
                child: Text(ventaDetalle.producto,
              ...
              Row(
                ...
                children: [
                  ...
                  Text(ventaDetalle.vedCantidad.toString(),style: _styleText)
                ],
              ),  
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              Row(
                ...
                children: [
                  ...
                  Text('\$${(ventaDetalle.vedPrecio * ventaDetalle.vedCantidad) - ventaDetalle.vedDescuento}',style: _styleText)
                ],
              ),   
              SizedBox(height: 30)
                ],
