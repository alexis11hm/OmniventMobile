...
class CashClosingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (_) => new CorteCajasProvider(), child: _Scaffold());
  }
}
            ...
            IconButton(
              ...
              onPressed: () {
                showSearch(
                  context: context,
                  delegate: DataSearch(
                      corteCajasProvider: corteCajasProvider), //query: 'Hola'
                );
              },
            ),
          ],
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(
                                  corteCajasProvider.cortesCaja[index].sucursal,
                                  style: TextStyle(
                                    fontSize: 24,
                              ...
                              Icon(Icons.store_sharp,
                                  size: 30, color: OmniventColors.naranja)
                            ],
                          ),
                          Text(
                              corteCajasProvider
                                  .cortesCaja[index].fleDescripcion,
                              style: TextStyle(
                                fontSize: 18,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                  corteCajasProvider.cortesCaja[index].fleFecha,
                                  style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w300,
                                  ))
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                  (corteCajasProvider.cortesCaja[index]
                                          .fleReferencia.isNotEmpty)
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                  '\$${corteCajasProvider.cortesCaja[index].fleImporte}',
                                  style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w500,
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      corteCajasProvider.cortesCaja[index].fleId
                                          .toString(),
                                      style: TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.w300,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      corteCajasProvider.cortesCaja[index].fopId
                                          .toString(),
                                      style: TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.w300,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      corteCajasProvider.cortesCaja[index].cacId
                                          .toString(),
                                      style: TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.w300,
...
class DataSearch extends SearchDelegate {
  ...
  buscarInformacion(String buscar) {
    print(buscar);
    final List<CorteCajaModel> listaCorteCajas = corteCajasProvider
        .cortesCajaBuscar
        .where((corteCaja) =>
            corteCaja.fleDescripcion
                .toLowerCase()
            ...
            corteCaja.fleFecha
                ...
                .toLowerCase()
                .contains(buscar.toLowerCase()) ||
            corteCaja.fleReferencia
                .toString()
                .toLowerCase()
                .contains(buscar.toLowerCase()) ||
            corteCaja.formaPago.toLowerCase().contains(buscar.toLowerCase()) ||
            corteCaja.fleObservaciones
                .toLowerCase()
                .contains(buscar.toLowerCase()) ||
            corteCaja.fleImporte
                .toString()
                .toLowerCase()
                .contains(buscar.toLowerCase()) ||
  ...
  Widget buildResults(BuildContext context) {
    ...
    return ListView(
        children: corteCajasProvider.cortesCaja
            .map((corteCaja) => ListTile(
                  leading: Hero(
                    tag: corteCaja.fleId,
                    child: FadeInImage(
